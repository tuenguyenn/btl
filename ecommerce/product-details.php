                    ...
                    <div class="product-details">
                        ...
                        <div class="col-sm-8">
                            ...
                            <h2 class="product"><?php echo $prodname; ?></h2>
                                ...
                                <p><span class="price"><?php echo str_replace(',', '.', number_format($prodprice * 25000));?>đ</span></p>
                                <p><span class="oriprice"><?php echo str_replace(',', '.', number_format($oriPrice * 25000));?>đ</span></p>
                                <br>
